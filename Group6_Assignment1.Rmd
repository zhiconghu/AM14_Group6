---
title: "Group6_Assignment1: Tanisha Yadav, Zhicong Hu, Roman Vazquez Lorenzo, Emma Flutsch, Sarah Wu "
...
>
> [add comments on why we use log returns? \* talk about some benefits]
...
> The autocorrelation function is a statistical technique we are using to plot the correlation coefficient against the lag, which is measured in terms of a number of periods. 
