...
> Comparing the stocks, it is interesting to note that Microsoft exhibited the most risk, with the highest variance. This means that GE's returns will be closer to their mean than MSFT's, but MSFT's mean is higher; taking a greater risk could lead to higher returns. As S&P500 is an index, it exhibits low variance. Lastly, GE seems to have the most outliers, with a higher kurtosis.
>
