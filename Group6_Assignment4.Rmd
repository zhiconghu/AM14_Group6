...
By looking at the cumulative proportion of our principal components, we can see that we need 36 components to explain 95% of the return variations.
...
* Higher average R-squared using PC as factors than factors from Fama-French factors

* Higher median R-squared using PC as factors than factors from Fama-French factors

* Lower standard deviation of R-squared using PC as factors than factors from Fama-French factors

## Q6: Limitations of Principal Component Factors

* Not Interpretable

* Optimize within our dataset but might not work for the future
